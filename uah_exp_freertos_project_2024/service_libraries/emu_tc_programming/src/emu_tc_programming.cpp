...
#define FT_TIME_step1 (UNITIME_AFTER_POWER_ON + 10)
#define FT_TIME_step2 (UNITIME_AFTER_POWER_ON + 15)

#ifdef FT_UAH_EXP_SERV_129_0666
EmuGSS_TCProgram129_2 prog_FT_129_0666_step1(FT_TIME_step1,
					"FT_UAH_EXP_SERV_129_0666 step 1, Set Kp ",0.4, 0.3);

EmuGSS_TCProgram129_1 prog_FT_0666_step2(FT_TIME_step2,
					"FT_UAH_EXP_SERV_129_0666 step 2, Set Command Vx and Vy ", 0.7, 0.3);
